# Pipelines Fabryki — Analytics Pipeline

Pipeline do automatyzacji zadań analitycznych:
- agregacja metryk z różnych źródeł,
- obliczenia KPI,
- generowanie raportów dla Meta-Agenta,
- eksport wyników.
